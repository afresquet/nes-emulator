...
use crate::opcodes::{AddressingMode, Mnemonic, OpCode};
...
impl CPU {
    ...
    pub fn run(&mut self) {
        let opcodes = OpCode::instruction_map();
...
trait Mem {
    ...
    fn mem_read_u16(&self, pos: u16) -> u16 {
        u16::from_le_bytes([self.mem_read(pos), self.mem_read(pos.wrapping_add(1))])
    }
